...
public sealed interface Expression extends Node permits PipeOperator, ArrayValue, BinaryExpression,
    Block, MemberAccess, ForeignFieldAccess, Function, FunctionCall, IfExpression, Loop, Match, Not,
